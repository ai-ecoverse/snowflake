/**
 * theme-carousel-a — Editorial Wide-Card carousel (variant A), 3-up.
 *
 * Authoring rows:
 *   Row 1: heading text
 *   Row 2: description text
 *   Row 3: quick links — pipe-separated pairs: "Label|URL, Label|URL, ..."
 *   Row 4+: tile rows — cells: image | eyebrow | headline | CTA text | URL
 *
 * Supports "dark" variant class for dark-surface rendering.
 */
