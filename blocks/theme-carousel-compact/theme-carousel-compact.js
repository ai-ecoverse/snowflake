/**
 * Theme Carousel Compact Block — Variant G: Stacked-Pair 4-up
 * Authoring rows:
...
export default function decorate(block) {
  ...
  wrapper.className = `theme-carousel-compact-wrapper ${surfaceClass}`;
  ...
  tileRows.forEach((row) => {
    ...
    photoDiv.className = 'tile-g-photo';
    if (imgEl) {
      ...
      empty.className = 'tile-g-photo-empty';
    ...
    eyebrowEl.className = 'tile-g-eyebrow';
